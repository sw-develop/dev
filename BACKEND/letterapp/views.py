...
class LetterRequestView(APIView):
    ...
    def get(self, request, mailbox_pk):
        ...
        try:
            ...
            if datetime.date(datetime.now()) > mailbox_obj.open_date:
                return HttpResponse("No! User accesses after mailbox is enclosed")
            ...
            return HttpResponse("No! The mailbox requested not exists in DB")
    ...
    def post(self, request, mailbox_pk):
        ...
        try:
            ...
            letter_obj.save()
            return HttpResponse("Ok! Saved in DB successfully")
